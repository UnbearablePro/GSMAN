class ErrorHandlerOVB {
  ...
  static handleError(e) {
    ...
    if (activeHandlingFlag) {
      ...
      if (response == true) {
        Logger.log(`User ${Owner.me.firstName} want to send a message to developer.`);
      ...
      if (SettingsOVB.isSentMailAutomaticalyToDeveloperWhenErrorOccursOn) {
  ...
  static checkActiveHandling(message) {
    ...
    SettingsOVB.isSentMailAutomaticalyToDeveloperWhenErrorOccursOn;
  }
