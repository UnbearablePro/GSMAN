// /**
//  * Provides functionality to handle reminders.
//  */
// class Reminder {

//   static createReminderRequest() {
//     HtmlUtils.openHtmlPopup(HtmlUtils.fileName.Reminder, 400, 500, "Seteaza reminder in calendar");
//   }

//   static createReminderRequestForSelectedPerson() {
//     if(SupplierUtils.checkPersonSupplierIntegrity()) {
//       HtmlUtils.openHtmlPopup(HtmlUtils.fileName.ReminderForSelectedPerson, 400, 500, "Seteaza reminder in calendar");
//     } else {
